...
public class CompletableFutureDemo {
    ...
    public void run(URL url) throws IOException, InterruptedException {
        urlToProcess = url;
        CompletableFuture.completedFuture(url).thenComposeAsync(this::readPage, executor).thenApply(this::getImageURLs)
         ...
         * HttpRequest request =
         * HttpRequest.newBuilder(urlToProcess.toURI()).GET().build();
    ...
    public static void main(String[] args) throws MalformedURLException, IOException, InterruptedException {
        new CompletableFutureDemo().run(new URL("https://tagbug.gitlab.io/"));
    }
}
